...
request.onsuccess = function(event) {
    ...
    // check if app is online, if yes run uploadPizza() function to send all local db data to all local db data to api
    if(navigator.onLine) {
...
function saveRecord(record) {
    // open a new transaction with the database with read and wrtie permissions
